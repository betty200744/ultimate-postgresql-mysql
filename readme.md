...
- **8. Data Types**
   - [8.1. Numeric Types]()
   - [8.2. Monetary Types]()
   - [8.3. Character Types](./postgresql/migrations/20200814135132_create_user.up.sql)
...
- **I. SQL Commands**
   ...
   - [CREATE INDEX — define a new index](./postgresql/migrations/20200815123355_create_modules.up.sql)
